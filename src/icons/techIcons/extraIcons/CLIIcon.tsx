const CLIIcon = () => (
	<svg width="25px" height="25px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none">
		...
		<g id="SVGRepo_iconCarrier">
			...
			<g fill="#b0b7bf">
				{' '}
				<path d="M3.924 5.02a.75.75 0 011.056-.096l3 2.5a.75.75 0 010 1.152l-3 2.5a.75.75 0 11-.96-1.152L6.328 8 4.02 6.076a.75.75 0 01-.096-1.056zM8.25 10.5a.75.75 0 000 1.5h3a.75.75 0 000-1.5h-3z"></path>{' '}
				<path
					fillRule="evenodd"
